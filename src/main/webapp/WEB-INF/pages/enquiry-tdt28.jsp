                ...
                <div class="content-wrapper content-wrapper-2">
                    <div class="block">
                        ...
                        <table>
                            ...
                            <с:url var="deleteButton" value="http://localhost:8080/enquiry_updateH"><%--  // сылаеться на @RequestMapping("/updateInfo")--%>
                            ...
                            <tr>
                                ...
                                <td>${emp.result}</td>
                                <td>
                                    <input type="button" value="Поставить Н" onclick="window.location.href='${deleteButton}'"/>
                                </td>
                            <tr>
                                </c:forEach>
                            </tr>
