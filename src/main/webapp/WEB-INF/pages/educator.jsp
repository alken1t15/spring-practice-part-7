    ...
    <div class="container content-container">
        ...
        <div class="tabs-content tabs-content-2 tab-is-active" id="tab3">
            <div class="content-wrapper content-wrapper-2">
                <form action="#" class="educator-from">
                    <p>Введите исходные данные о преподавателе</p>
                    <input type="text" name="info" placeholder="Информация  преподавателе">
                    <button type="submit" class="btn btn-25">Найти</button>
                </form>
