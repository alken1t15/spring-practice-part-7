...
<style><%@include file="./css/exchange.css"%></style>
<style><%@include file="./css/exchange-responsive.css"%></style>
...
/>
    ...
    <link rel="stylesheet" href="./styles/exchange-responsive.css">
...
<section class="content">
        <div class="container content-container">
            <div class="image-box">
                <img src="./img/exchange.jfif" alt="" class="content__img">
            </div>
